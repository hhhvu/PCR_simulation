...
def save_curve_as_image(curve_idx):
    ...
    imgs_folder = 'data/curve_imgs_new_cleaner_no_invalid'
...
if __name__ == "__main__":
    ...
    with open('data/new_full_curve_dict_fn_no_invalid.pkl', 'rb') as file:
        curve_dict = pkl.load(file)

    #target_df = pd.read_csv('data/groundtruth_df_target_data_split_v2.csv')
    target_df = pd.read_csv('data/new_groundtruth_df_target_data_no_invalid.csv')
